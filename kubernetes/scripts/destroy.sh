...
#
# Options will be passed through to the platform-specific script.
################################################################################
...
select_platform() {
    print_color "$BOLD" "
╔═══════════════════════════════════════════════════════════════╗
║         MiniPrem Multi-Cloud Kubernetes Destruction           ║
╚═══════════════════════════════════════════════════════════════╝
"
...
delegate_to_platform_script() {
    local script_path="$SCRIPT_DIR/$DESTROY_SCRIPT"

    info "Delegating to platform-specific script: $DESTROY_SCRIPT"
    ...
    print_color "$BOLD" "
╔═══════════════════════════════════════════════════════════════╗
║              Starting $PLATFORM_NAME Destruction               ║
╚═══════════════════════════════════════════════════════════════╝
"
...
main() {
    ...
    # Delegate to platform-specific destruction script
    delegate_to_platform_script "$@"
}
