...
if [ "$CNS_INSTALLED" = true ]; then
    ...
    case "${1:-}" in
        ...
        -h|--help|help)
            ...
            echo "  upgrade --restart - Just restart pods (no config change)"
            echo "  upgrade --clear-secrets - Clear TTS keys (use Admin Portal)"
        ...
        *)
            ...
            echo "  ./miniprem.sh upgrade  - Apply config changes"
